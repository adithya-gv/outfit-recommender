...
We decided to grab only the two closest neighbors for each input image for this section, since beyond this it was getting pretty inaccurate results. 
